...
import { MyPatientsTable } from "@/components/my-patients-table"; // ✅ Corrected import path
    ...
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      <Tabs defaultValue="access" className="space-y-4">
        <TabsList className="bg-blue-50">
          ...
          <TabsTrigger value="patients" className="data-[state=active]:bg-white">
            My Patients
          </TabsTrigger>
        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card className="border-blue-100 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Patient data analytics and insights</CardDescription>
            </CardHeader>
            <CardContent>
