...
import { HealthRecordsCard } from "@/components/health-records-card";
import { PendingAccessCard } from "@/components/pending-access-card";
import { AccessHistoryCard } from "@/components/access-history-card";
import { UploadRecordModal } from "@/components/modals/UploadRecordModal";
import { supabase } from "@/lib/supabaseClient";
import { PendingAccessControl } from "@/components/ui/pending-access-control";
import { AccessHistoryTimeline } from "@/components/ui/access-history-timeline";
export default function PatientDashboard() {
  ...
  const fetchSummary = async () => {
    const { data: records, error: recordsError } = await supabase
      ...
      .select("id, record_name, record_type, record_date, file_url")
